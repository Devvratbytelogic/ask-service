...
export default function RequestFilters({ search, onSearchChange, statusFilter, onStatusFilterChange }: RequestFiltersProps) {
    return (
        <>
            ...
            <div className="w-max lg:min-w-50">
                <Dropdown>
                    <DropdownTrigger>
                        ...
                        >
                            {filterItems.find(item => item.key === statusFilter)?.label}
                        </Button>
                    </DropdownTrigger>
                    <DropdownMenu
