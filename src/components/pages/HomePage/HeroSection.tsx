...
export default function HeroSection() {
    return (
        <section className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-linear-to-br from-[#FAFBFF] via-[#F0F4FF] to-[#FFF8ED] px-[4%] py-8 text-center sm:px-[5%] sm:py-12">
            <div
                aria-hidden
                className="pointer-events-none absolute -top-[200px] -right-[200px] size-[700px] rounded-full bg-[radial-gradient(circle,rgba(27,79,255,0.06)_0%,transparent_70%)]"
            />
            <div
                aria-hidden
                className="pointer-events-none absolute -bottom-[100px] -left-[100px] size-[500px] rounded-full bg-[radial-gradient(circle,rgba(245,158,11,0.07)_0%,transparent_70%)]"
            />

            <div className="relative z-1 w-full max-w-[720px]">
                <div className="mb-7 inline-flex animate-hero-fade-down items-center gap-2 rounded-full border-[1.5px] border-blue-light bg-white px-3.5 py-1.5 text-[13px] font-semibold text-primaryColor shadow-[0_2px_8px_rgba(27,79,255,0.1)]">
                    <span className="size-1.5 shrink-0 animate-hero-pulse rounded-full bg-trust-green" />
                    +1 200 professionnels vérifiés
                </div>

                <h1 className="mb-5 animate-hero-fade-up text-[clamp(38px,4.5vw,56px)] leading-[1.1] font-extrabold tracking-[-1.5px] text-slate-900 [animation-delay:0.1s]">
                ...
                <p className="mx-auto mb-9 max-w-[520px] animate-hero-fade-up text-[17px] leading-[1.65] text-slate-500 [animation-delay:0.2s]">
                ...
                <div className="grid animate-hero-fade-up grid-cols-1 gap-3 sm:grid-cols-2 [animation-delay:0.3s]">
                    ...
                    >
                        ...
                        <p className="mb-3.5 text-[13px] leading-normal text-slate-500">
