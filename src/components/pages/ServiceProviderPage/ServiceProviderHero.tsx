...
export default function ServiceProviderHero() {
    ...
    return (
        <section className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-linear-to-br from-slate-900 from-0% via-[#1B2040] via-45% to-[#1A1000] to-100% px-[5%] pt-[120px] pb-20 text-center -mt-16">
            <div
                aria-hidden
