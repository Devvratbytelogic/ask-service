...
function BenefitItem({ benefit }: { benefit: Benefit }) {
    return (
        <div className="flex items-start gap-3.5 rounded-2xl border border-white/7 bg-white/4 p-5 transition-all duration-200 hover:border-amber-500/20 hover:bg-white/7">
            ...
            <div>
                <strong className="mb-1 block text-sm font-bold text-white">
                    {benefit.title}
                </strong>
...
export default function ServiceProviderBenefits() {
    return (
        <section className="relative overflow-hidden bg-slate-900 px-[5%] py-[100px]">
            <div
                aria-hidden
                className="pointer-events-none absolute -top-[200px] -right-[100px] size-[600px] rounded-full bg-[radial-gradient(circle,rgba(245,158,11,0.08)_0%,transparent_65%)]"
            />
            ...
            <div className="relative z-1 mb-[60px] text-center">
                ...
                <h2 className="text-[clamp(28px,3.5vw,42px)] leading-[1.12] font-extrabold tracking-[-0.8px] text-white">
