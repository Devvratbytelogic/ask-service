...
export default function ContactUsPage() {
    ...
    return (
        <>
            <div className="min-h-screen bg-appBg body_x_axis_padding container_y_padding_lg w-full max-w-2xl md:max-w-none md:w-2/3 mx-auto space-y-10 sm:space-y-12 md:space-y-16">
