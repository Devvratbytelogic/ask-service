...
import {
  getClientDashboardRoutePath,
  getCreateRequestRoutePath,
  getMyQuotesRoutePath,
} from '@/routes/routes'

const NAV_LINKS = [
  { label: 'My requests', href: getClientDashboardRoutePath() },
  { label: 'New request', href: getCreateRequestRoutePath() },
  { label: 'My quotes', href: getMyQuotesRoutePath() },
] as const
