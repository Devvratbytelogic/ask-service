...
const Header = () => {
    ...
    const isVendorMessagePage = pathname === '/vendor/message'
    return (
        <div className={`navbar_x_axis_padding navbar_y_axis_padding ${isVendorMessagePage ? 'sticky' : 'fixed'} top-0 left-0 right-0 z-9`} id="main_navbar">
