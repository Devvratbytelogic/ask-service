...
function TestimonialCard({ testimonial }: { testimonial: Testimonial }) {
    return (
        <article className="rounded-[20px] border-[1.5px] border-slate-100 bg-white p-7 shadow-[0_2px_8px_rgba(0,0,0,0.04)] transition-all duration-200 hover:-translate-y-0.5 hover:border-amber-500 hover:shadow-[0_8px_24px_rgba(245,158,11,0.1)]">
            <div className="mb-3.5 flex gap-[3px] text-[15px] text-amber-500">
                ★★★★★
            </div>
            <p className="mb-5 text-sm leading-[1.7] text-slate-600 italic">
...
export default function ServiceProviderTestimonials() {
    return (
        <section className="bg-slate-50 px-[5%] py-[100px]">
